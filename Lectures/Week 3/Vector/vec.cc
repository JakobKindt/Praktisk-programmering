...
// vec operator+(vec v, vec w) {v += w; return v;} // Addition of vectors. Here we save one assignment constructor. 
// vec operator+(vec v, const vec& w) {c = x*4 + b; return c;}?? // Addition of vectors. Here we save one assignment constructor. 
